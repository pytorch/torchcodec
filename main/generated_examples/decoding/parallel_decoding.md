...
```
median = 3.70s ± 0.06
Speedup compared to sequential: 2.91x with 16 FFmpeg threads.
```
...
```
median = 4.38s ± 0.07
Speedup compared to sequential: 2.46x with 16 processes.
```
...
```
median = 1.44s ± 0.06
Speedup compared to sequential: 7.46x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 25.956 seconds)
